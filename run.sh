...
ARGS=
for ARG in port key login zones mqtt_discovery_max_zone serialport pima_host pima_port mqtt_host mqtt_port mqtt_client_id mqtt_topic ssl_cert ssl_key; do
